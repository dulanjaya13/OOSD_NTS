...
public final  class Subject_Attendance_Domain extends Attendance{
    ...
    public void saveSubjectAttendanceToDatabase(int [][]table) throws ClassNotFoundException, SQLException{
        this.table = table;
        getAccess().saveToDatabase(this.table,this.date,this.batch,this.level,LectureNumber,subject);
    }
    public int [][] getSubjectAttendance() throws ClassNotFoundException, SQLException{
        return getAccess().getSubjectAttendance(this.date,this.batch,this.level,this.LectureNumber,subject);
    }
    public void updateSubjectAttendance(int [][]table) throws ClassNotFoundException, SQLException{
        this.table = table;
