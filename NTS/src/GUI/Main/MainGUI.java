...
public class MainGUI extends javax.swing.JFrame implements MainGUIObserver {
    ...
    private Student_Data_Access stuAccess = new Student_Data_Access(db);
    private Lecturer_Data_Access lecAccess = new Lecturer_Data_Access(db);
    private Subject_Data_Access subAccess = new Subject_Data_Access(db);
    ...
    public void startUpSettings() {
        try {
            ...
            frameSettings();
            addListeners();
            startUpComponentVisibility();
            subjectInformationSettingUp();
    ...
    public void startUpComponentVisibility() {
    ...
    public void searchStudentbyID() {
        ...
        try {
            if(logId==0) {
                ...
                stu = stuAccess.getProfile(Integer.parseInt(txtSearchbyStudentID1.getText()));
            }
    ...
    public void addListeners() throws ClassNotFoundException, SQLException {
        //student search 
        ...
        //lecturer search
        txtSearchLecbyName.getDocument().addDocumentListener(new DocumentListener() {
            ArrayList<String> lectures = lecAccess.getLectureNames();

            @Override
            public void insertUpdate(DocumentEvent e) {
                popUpSearchbyName.setVisible(false);
                if (txtSearchLecbyName.getText().length() > 3) {
                    popUpSearchbyName.removeAll();
                    for (String lecturename : lectures) {
                        if (lecturename.toLowerCase().contains(txtSearchLecbyName.getText().toLowerCase())) {
                            JMenuItem i = new JMenuItem(lecturename);
                            i.addActionListener(new ActionListener() {
                                @Override
                                public void actionPerformed(ActionEvent e) {
                                    txtSearchLecbyName.setText(i.getText());
                                    popUpSearchbyName.setVisible(false);
                    ...
                    popUpSearchbyName.show(txtSearchLecbyName, 0, 20);
                    txtSearchLecbyName.requestFocus();
                }
            }
    ...
    public void subjectInformationSettingUp() {
        Subject sub;
        //methods to get all subjects
    }
    ...
    private void initComponents() {
        ...
        pnlLecDbControls1 = new javax.swing.JPanel();
        ...
        txtSearchbyStudentID1 = new javax.swing.JTextField();
        lblStudentID1 = new javax.swing.JLabel();
        lblStudentName1 = new javax.swing.JLabel();
        txtSearchbyStudentName = new javax.swing.JTextField();
        ...
        pnlLecDbControls1.setBorder(javax.swing.BorderFactory.createEtchedBorder());
        ...
        javax.swing.GroupLayout pnlLecDbControls1Layout = new javax.swing.GroupLayout(pnlLecDbControls1);
        pnlLecDbControls1.setLayout(pnlLecDbControls1Layout);
        pnlLecDbControls1Layout.setHorizontalGroup(
            pnlLecDbControls1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addGroup(pnlLecDbControls1Layout.createSequentialGroup()
                .addContainerGap()
                .addGroup(pnlLecDbControls1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                ...
                .addGap(43, 43, 43)
                .addGroup(pnlLecDbControls1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                ...
                .addContainerGap())
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, pnlLecDbControls1Layout.createSequentialGroup()
                .addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                .addComponent(lblStuDbControls1)
                .addGap(34, 34, 34))
        );
        pnlLecDbControls1Layout.setVerticalGroup(
            pnlLecDbControls1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addGroup(pnlLecDbControls1Layout.createSequentialGroup()
                .addGap(9, 9, 9)
                .addComponent(lblStuDbControls1)
                .addGap(18, 18, 18)
                .addGroup(pnlLecDbControls1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
        ...
        pnlLecturerControlsOfPrincipalLayout.setHorizontalGroup(
            ...
            .addGroup(pnlLecturerControlsOfPrincipalLayout.createSequentialGroup()
                ...
                .addGroup(pnlLecturerControlsOfPrincipalLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(pnlLecDbControls1, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
        ...
        pnlLecturerControlsOfPrincipalLayout.setVerticalGroup(
            ...
            .addGroup(pnlLecturerControlsOfPrincipalLayout.createSequentialGroup()
                .addContainerGap()
                .addComponent(pnlLecDbControls1, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                    ...
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, pnlStudSearchLLayout.createSequentialGroup()
                        ...
                        .addGroup(pnlStudSearchLLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, pnlStudSearchLLayout.createSequentialGroup()
                                ...
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                                .addComponent(txtSearchbyStudentID1, javax.swing.GroupLayout.PREFERRED_SIZE, 153, javax.swing.GroupLayout.PREFERRED_SIZE))
                            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, pnlStudSearchLLayout.createSequentialGroup()
                                .addGap(0, 0, Short.MAX_VALUE)
                            ...
                            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, pnlStudSearchLLayout.createSequentialGroup()
                                ...
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                                .addComponent(txtSearchbyStudentName, javax.swing.GroupLayout.PREFERRED_SIZE, 153, javax.swing.GroupLayout.PREFERRED_SIZE)))))
                .addContainerGap())
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, pnlStudSearchLLayout.createSequentialGroup()
                .addGap(0, 0, Short.MAX_VALUE)
        ...
        pnlStudSearchLLayout.setVerticalGroup(
            ...
            .addGroup(pnlStudSearchLLayout.createSequentialGroup()
                ...
                .addGroup(pnlStudSearchLLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(txtSearchbyStudentID1, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(lblStudentID1))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(btnSearchbyID1)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addGroup(pnlStudSearchLLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(txtSearchbyStudentName, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(lblStudentName1))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(btnSearchbyName1)
                .addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
    ...
    private void btnEditInfoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEditInfoActionPerformed
        new EditStudentInformation(this, stuAccess, txtSearchStudentbyID.getText()).setVisible(true);
    ...
    private javax.swing.JPanel pnlLecDbControls1;
    ...
    private javax.swing.JTextField txtSearchbyStudentID1;
    private javax.swing.JTextField txtSearchbyStudentName;
